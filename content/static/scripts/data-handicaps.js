...
app.handicaps = [{
    ...
    },
    {
        ...
        points: [1],
        tags: ["deadlands"],
        descr: "Ein Gewitter aus der Hölle selbst wird diesen dösenden Doolie nicht aufwecken. Sobald er abfällt, muss er eine Notizrolle (-4) machen, um aufzuwachen. Er erleidet auch eine Strafe von -4 bei Vigor-Würfen, die gemacht werden, um wach zu bleiben."
    },
    {
        id: "LuegendeAugen",
        name: "Lügende Augen",
    ...
    },
    {
        ...
        points: [1],
        tags: ["deadlands"],
        descr: "Melasse an einem kalten Tag bewegt sich schneller als Ihr Held. Verringern Sie sein Tempo um 1. Dies ist kumulativ mit dem Lame Hindernis, wenn Sie sich wirklich auf das nächste Schildkröten- und Hasenrennen einlassen wollen. Wir überlassen es Ihnen, herauszufinden, welcher von ihnen Sie sind."
    },
    {
        id: "Anfaenger",
        name: "Anfänger",
    ...
    },
    {
        ...
        name: "Alt",
        points: [2],
        descr: "Dein Abenteurer hat schon einige Jahre auf dem Buckel, ist aber auch noch nicht reif fürs Altersheim. Seine Bewegungsweite sinkt um –1, und er verringert das Ergebnis seines Sprintwürfels um 1 (Minimum 1). Er erleidet ausserdem einen Abzug von –1 auf Proben mit Geschicklichkeit, Konstitution und Stärke, aber nicht bei verknüpften Fertigkeiten. Auf der positiven Seite erhält der Charakter durch die Weisheit des Alters 5 zusätzliche Fertigkeitspunkte, die er für alle Fertigkeiten verwenden kann, die mit Verstand verknüpft sind."
    },
    {
        id: "Analphabet",
        name: "Analphabet",
    ...
    },
    {
        ...
        name: "Blind",
        points: [2],
        descr: "Der Charakter kann überhaupt nicht sehen. Er erleidet einen Abzug von –6 auf körperliche Aufgaben, die Sicht erfordern (Entscheidung der SL). Andererseits bekommen blinde Charaktere ein freies Talent ihrer Wahl, um dieses besonders schwere Handicap auszugleichen."
    },
    {
        id: "Blutruenstig",
        name: "Blutrünstig",
        points: [2],
        descr: "Dein Held nimmt niemals Gefangene – sofern er nicht unmittelbar von einem Vorgesetzten überwacht wird. Seine kaltblütige Skrupellosigkeit lässt seine Widersacher gleichermassen reagieren, kostet ihn oft wichtige Informationen, sorgt für ständig neue Feinde und bringt ihn in Schwierigkeiten mit seinen Vorgesetzten oder der Obrigkeit, abhängig vom Setting."
    },
    {
        id: "Duennhauutig",
        name: "Dünnhäutig",
    ...
    },
    {
        ...
        name: "Ehrenkodex",
        points: [2],
        descr: "Ehre ist deinem Charakter sehr wichtig. Er hält sein Wort, misshandelt oder tötet keine Gefangenen, und versucht sich insgesamt im Rahmen dessen zu verhalten, was er einem Gentleman (oder einer Dame) für angemessen erachtet."
    },
    {
        id: "Eifersuuechtig",
        name: "Eifersüchtig",
    ...
    },
    {
        ...
        name: "Heldenhaft",
        points: [2],
        descr: "Diese edle Seele sagt niemals nein zu Menschen in Not. Er muss nicht froh darüber sein, aber er kommt immer zur Rettung jener, die sich nicht selbst helfen können. Er ist der erste, der in ein brennendes Gebäude läuft, stimmt normalerweise zu, Monster für wenig oder gar kein Geld zu jagen, und ist sehr empfänglich für eine tränenreich vorgetragene Geschichte."
    },
    {
        id: "Impulsiv",
        name: "Impulsiv",
        points: [2],
        descr: "Dieser Draufgänger wird fast immer erst drauflosstürmen und dann schauen wohin es geht. Er denkt eine Situation selten zu Ende ehe er handelt."
    },
    {
        id: "Jung",
        name: "Jung",
    ...
    },
    {
        ...
        name: "Skrupellos",
        points: [1, 2],
        descr: "Dieser Fanatiker wird fast alles tun, um seine Ziele zu erreichen. Bei einem schweren Handicap hat er keine Hemmungen, jedem zu schaden, der ihm in die Quere kommt. Bei einem leichten Handicap wird er nur jenen schaden, die sich ihm direkt in den Weg stellen."
    },
    {
        id: "Stumm",
        name: "Stumm",
        points: [2],
        descr: "Dein Charakter kann nicht sprechen, entweder von Geburt an oder wegen irgendeines Traumas oder einer Verletzung. Er kann bei Bedarf anderen schriftliche Nachrichten zukommen lassen, Zeichensprache oder eine Kombination visueller Kommunikationsmittel verwenden. Auf Sicht basierende Kommunikation erfordert möglicherweise eine Wahrnehmungsprobe, um sie richtig zu sehen (Beleuchtung und ähnliche Abzüge werden eingerechnet)."
    },
    {
        id: "Stur",
        name: "Stur",
        points: [1],
        descr: "Sture Personen wollen immer ihren Kopf durchsetzen und geben niemals zu, dass sie Unrecht haben. Selbst wenn es quälend offensichtlich ist, dass sie einen Fehler gemacht haben, versuchen sie ihr Handeln mit Halbwahrheiten und Rationalisierungen zu rechtfertigen."
    },
    {
        id: "Tick",
        name: "Tick",
    ...
    },
    {
        ...
        name: "Vorsichtig",
        points: [1],
        descr: "Dieser Planer verkörpert Zurückhaltung und Vorsicht. Er trifft niemals überstürzte Entscheidungen und plant gerne im Voraus."
    },
    {
